...
public class ModEnUsLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("fluid.pasterdream.sea_salt_slumber_palm_beverage","Sea Salt Slumber Palm Beverage(fluid)");
        add("fluid.pasterdream.slumber_palm_juice","Slumber Palm Juice(fluid)");
        add("fluid.pasterdream.slumber_palm_club_soda","Slumber Palm Club Soda(fluid)");
        ...
        add("book.pasterdream.title.关于美梦世界的研究", "Research on the Sweet Dream World");
        add("book.pasterdream.title.染梦世界跃迁石", "The Dyedream World Leapstone");
        add("book.pasterdream.title.梦境世界的本质", "The Essence of the Dream World");
        ...
        add("book.pasterdream.title.风铃笼", "Windbell Cage");
        ...
        add("tooltip.pasterdream.brooch_of_white_orchid.flavor", "§7§o--I fade into formlessness, now enjoy the glory you deserve");
        ...
        add("tooltip.pasterdream.kaichu_omamori.flavor", "§7§o--Alirea custom item");
        ...
        add("message.pasterdream.broken_portal.已传送出或清除暗影地牢内的其他生物", "Teleported out or Discarded the Living Entities in the Shadow Dungeon.");
        ...
        add("tooltip.pasterdream.prophecy_card.sin.description.4", "§7§o--FACE YOUR SIN.");
        ...
        add("pasterdream.seniors_dream.entry.san.page2", "As your SAN changes, so does your state: when you are energized, you will feel Cheer Up. As you slowly begin to lose your sanity, your state will slide from \"Lethargy\" all the way into the abyss of madness.");
        add("pasterdream.seniors_dream.entry.san.page3", "SAN changes brought by the environment:$(br)Your SAN changes are influenced by where you are — generally speaking, the biome you are in and the nearby light level affect your state of mind.");
        add("pasterdream.seniors_dream.entry.san.page4", "The biome influence mainly shows as:$(br)In the Deep Dark and beneath the Lamp Shadow, your sanity is lost and you slowly sink into the mire of madness.$(br)In the Dyedream World, you feel at ease and your sanity slowly recovers.$(br)Beyond that, other biomes won't noticeably affect your sanity.$(br)Some equipment carries a \"Sanity Aura\" that further influences your sanity beyond the environmental effects.");
        add("pasterdream.seniors_dream.entry.san.page5", "Other situations:$(br)Around Shadow Creatures there is an Insanity Aura that drains your sanity; some equipment also devours your sanity; an overly dark environment can also drive you mad.$(br)Some foods can heal your mind and restore your SAN; bright environments are good for your mind as well. Or, you could face the darkness head-on and slay Shadow Creatures — doing so just might ease your madness.");
        ...
        add("pasterdream.seniors_dream.entry.dyedream_world_leapstone", "Dyedream World Leapstone");
        add("pasterdream.seniors_dream.entry.dyedream_world_leapstone.page0", "As a Dreamseeker, you may often need to travel between the Overworld and the Dyedream World. But the usual methods are either too mentally taxing or demand all kinds of materials, making them hard to use as a long-term, stable gateway into the dream. Fortunately, a Dreamseeker mage developed a Leapstone that can build a stable portal frame, letting you establish a reliable passage between the Dyedream World and the Overworld. Dyedream Dust is all it takes to activate the portal.$(br)In both the Dyedream World and the Overworld, you may find traces of the Pure White Mage's experiment — perhaps you can rebuild the frame?");
        add("pasterdream.seniors_dream.entry.dyedream_world_leapstone.page1", "Note that the portal works by creating an artificial rift, which naturally brings some contamination — choose the location for your portal carefully.$(br)$(#ff0000)This block is test content exclusive to 0.2.0; its associated structures do not actually generate in-game.");
        ...
        add("pasterdream.seniors_dream.entry.break_wind_knight_altar.page0", "Above the Wind Moor Archipelago lies another sizable island — the Wind Knight Altar. Now only ruins remain of the arena, and the knight that symbolizes protection has gradually fallen into slumber.$(br)To awaken the Wind Knight, you need a spark of lightning. Even after sleeping so long, once it wakes it will still carry out its mission of protecting her — only...$(br)Perhaps strengthened by dream power, if you assemble a knight's form from the sky island's metal and gems and then charge it with lightning, it will awaken as well.");
        add("pasterdream.seniors_dream.entry.break_wind_knight_altar.page1", "--Turns out you have to assemble it yourself after all.");
        add("pasterdream.seniors_dream.entry.windbell_cage", "Windbell Cage");
        add("pasterdream.seniors_dream.entry.windbell_cage.page0", "This is a colossal structure floating in the misty dream clouds — a huge birdcage above, with a giant... flower? hanging below.$(br)Inside the cage are some basic supplies and some Melt Dream Crystal Chests — don't miss them. There's nothing in the hanging flower though, so there's no need to go all the way down again.$(br)Since it's called a Wind Bell Cage, it wouldn't make sense for the whole structure to have nothing to do with sound or music. So you look up at the top of the cage, where a faint light seems to linger — perhaps something is hidden up there.");
        add("pasterdream.seniors_dream.entry.windbell_cage.page1", "--It is said that the Dream Builder came across Wen's building tutorial, hence this structure. Thanks to Wen for the help.");
        ...
        add("book.pasterdream.content.风铃笼", "They say the illness I have is really troublesome. I still remember the pained expressions on my mom and dad's faces when I was diagnosed with leukemia.\nChemotherapy and recuperation came and went in turns; not only did all my hair fall out, but my body ached quite a bit too.\nWhat made me happy, though, was that not only my parents and the doctor kept vigil by my bedside — my classmates and teachers all came to visit me, and they gave me a super pretty wind chime, saying it had the power to grant blessings!\nFor some reason, every time I sleep I dream of a blue-green world with clouds and balloons floating in the sky, and in my dreams I fly around freely and carefree.\nAnd not only does it have clouds — there are statues of the characters I love, and even the knight of my fantasies appears in this world!\nJust as I was flying around sightseeing, the wind suddenly shifted direction, accompanied by a crisp chime. Following the sound, I found a strange building held up aloft.\nWhat makes it strange, you ask... it looks like a super-sized version of the wind chime my classmates gave me — so big you could even live in it!\nThe sound of the wind chime is so lovely~\nWhen I opened my eyes again and saw the hospital room ceiling, it was already noon the next day. My parents said I rarely slept that long.\nOutside the window, the wind chime was stirred by the breeze, making exactly the same sound as in my dream. It was so reassuring.\nBy Vivian");
        add("book.pasterdream.content.关于美梦世界的研究", "According to Qianye's account, when she entered this place by drinking Dyedream Juice and sleeping, she saw my body vanish outright — just as when passing through the rift.\nIn other words, rather than a dream, this is better described as another world. Unlike ordinary dreams, where only the spirit — or rather the mind — can arrive, when one comes to this world, body and spirit \"cross over\" together.\nBut that doesn't explain why the pain and wakefulness brought by the Boneneedle let me wake up in bed again.\n\"Unless that flower...\" Qianye speculated, \"itself also condensed the power of the dream.\"\n\"Or else, we have already been influenced by the dream...\"\nBy Jixing");
        add("book.pasterdream.content.染梦世界跃迁石", "Annoying, so annoying, extremely annoying!\nBecause of my research, I need to travel back and forth between the Dyedream World and the Overworld for long periods. But honestly, climbing up to the Dyedream sky islands every time is exhausting, and using Dream Juice requires gathering materials and brewing it each time — such a hassle. And leaving the dream requires stabbing myself with the Pale Boneneedle — it hurts so much!\nAaargh, this is maddening! I have to find a way to make a stable passage!\nDrawing on the corruption of the Dyedream Rift, I hit upon the idea of using the Dyedream World's energy to create artificial corruption, thereby establishing a stable passage. Surrounding Dyedream Dust with eight blocks of Dyedream Crystal triggers a wondrous reaction; the new crystal block produced has the function of creating an artificial rift. Hmm, let's call it the Dyedream World Leapstone — sounds rather nice. This will put an end to that maddening daily stair-climbing to the sky islands.\nBut it still has an insurmountable problem: though it creates an artificial rift, it is still, after all, corruption. In the Overworld, it will gradually corrupt its surroundings into something like the Dyedream World.\nIn other words, where there is a passage, a connection, an intersection, there is bound to be corruption — it's unavoidable. Only the degree differs.\nMm-mm... I can't do anything about this point, really nothing. If anyone uses this technology later, do take note.\nEr, if it could corrupt infinitely, I might try to turn it into a weapon? But clearly it can't...\nNo wait, why should I let others use my technology? No, no!\nBy Lingran");
        add("book.pasterdream.content.梦境世界的本质", "While reviewing my earlier research on the Dyedream World Leapstone, I noticed a very strange problem: judging from the notes left by various predecessors, this place should be a dream. But if it is a dream, why can it establish a passage with the Overworld — reality itself — and even corrupt the Overworld?\nUnless you claim the master of this dream has the power to make wishes come true in the Overworld... nonsense? Such power, even in magic, would be close to the Root, akin to a god — whoever proposes that theory is the one truly dreaming, surely?\nThinking this way, many problems emerge: spoils obtained exploring the dream world can be brought back to the Overworld; wounds or even near-death in the dream are reflected on one's body in the Overworld; and when I earlier returned from the Lamp Shadow on the verge of madness, shadow monsters actually appeared in the Overworld.\nI contacted Qinglan via message magic and discussed the matter with him, and in the end we reached a conclusion:\nThe common essence of all dream worlds is that they are otherworlds bearing the nature of dreams — like the Nether and the End, otherworlds independent of the Overworld. This easily explains why dream worlds have passages to the Overworld, and why things from the dream can be taken out: because it merely has the nature of a dream, but is essentially an otherworld. The Dyedream Rift and my Leapstone thus serve a role similar to Nether portals — they construct passages between the two worlds.\nThen why can we still enter the dream world by sleeping in a special way? Whoever asks this question is a bit foolish — because it has the nature of a dream, and having the nature of a dream means one can enter it through sleep.\nBut seen this way, it's entirely normal that falling, being wounded, or even nearing death in the dream world won't let us leave it. So what is the principle by which the Pale Boneneedle lets us swiftly return to the Overworld? On this question the two of us had no clue for the moment, but I suspect the Pale Snow Lotus is involved. So I asked Qinglan to research the Pale Snow Lotus; I'm too occupied for now.\nWith this, we're one step closer to finding the truth of the dream — how thrilling.\nBy Lingran");
        ...
        add("tooltip.pasterdream.wind_spirit.effect1", "§7▪ §9Increases arrow velocity by 50%");
        add("tooltip.pasterdream.wind_spirit.lore", "§7§o--The wind blesses you");

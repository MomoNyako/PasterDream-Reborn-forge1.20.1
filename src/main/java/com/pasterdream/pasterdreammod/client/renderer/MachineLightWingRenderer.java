...
import com.pasterdream.pasterdreammod.client.model.MachineLightWingModel;
...
public class MachineLightWingRenderer extends GeoArmorRenderer<MachineLightWingItem> implements ICurioRenderer {

    public MachineLightWingRenderer() {
        super(new MachineLightWingModel());
    ...
    @Override
    public RenderType getRenderType(MachineLightWingItem animatable, ResourceLocation texture,
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        if (!(stack.getItem() instanceof MachineLightWingItem item)) return;
